...
mapLayers.push({name:'Tên các trạm bơm',ename:'Label names for pumping stations',l:'Pumping_station_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'Pumping_station_points_label',style:'Pumping_station_points_label',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Tên các tuyến đê',ename:'Label names for dikes',l:'Dike_Polyline',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'dike_polyline_label',style:'dike_polyline_label',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Tên các trạm thủy văn',ename:'Label names for hydrological stations',l:'Hydrological_station_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'Hydrological_station_points_label',style:'Hydrological_station_points_label',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Tên các huyện',ename:'Label names for ',l:'District_People_committee_Point',htmacdinh:0,htdongian:1,htchitiet:1,httuychon:1,singleTile:true,estyle:'District_People_committee_Point_label',style:'District_People_committee_Point_label',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Tên của các công trình kè được đánh giá tổn thương',ename:'Label names for vulnerable embankments',l:'Vulnerability_embankments_polyline',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'Vulnerability_embankments_polyline_label',style:'Vulnerability_embankments_polyline_label',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Tên của các công trình thủy lợi được đánh giá tổn thương',ename:'Label names for vulnerabe irrigations',l:'Vulnerability_irrigation_points_font_point',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'Vulnerability_irrigation_points_label',style:'Vulnerability_irrigation_points_label',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Tên của các công trình đường giao thông được đánh giá tổn thương',ename:'Label names for vulnerable roads',l:'Vulnerability_roads_polyline',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'vulnerability_roads_polyline_label',style:'vulnerability_roads_polyline_label',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Nhà máy điện',ename:'Electricity power plan',l:'Electricity_power_plan_point',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Nhà máy',ename:'Factory',l:'Factory_point',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Bưu điện',ename:'Post office',l:'Post_office_point',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Trạm bơm',ename:'Pumping station',l:'Pumping_station_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'Pumping_station_points',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Đê',ename:'Dike',l:'Dike_Polyline',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'dike_polyline',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Cống',ename:'Culvert',l:'Culvert_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'Culvert_points',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Trạm thủy văn',ename:'Hydrological station',l:'Hydrological_station_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'Hydrological_station_points',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Hồ chứa dung tích lớn',ename:'Large reservoir',l:'Large_reservoir_polygon',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'large_reservoir_polygon',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Trạm khí tượng',ename:'Meteorological station',l:'Meteorological_station_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'Meteorological_station_points',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Trường học',ename:'School',l:'School_point',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Bệnh viện',ename:'Hospital',l:'Hospital_point',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Trụ sở văn phòng phòng chống lụt bão',ename:'DDMFSC Office',l:'DDMFSC_Office_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'DDMFSC_Office_points',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Nơi trú ẩn',ename:'Safety place',l:'Safety_place_points',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
mapLayers.push({name:'UBND tỉnh',ename:'Provincial People Committee',l:'Province_People_committee_Point',htmacdinh:0,htdongian:1,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
mapLayers.push({name:'UBND huyện',ename:'District People committee',l:'District_People_committee_Point',htmacdinh:0,htdongian:1,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'District_People_committee_Point',isBaseLayer:false,visibility:true});
mapLayers.push({name:'UBND xã',ename:'Communal People Committee',l:'Communal_People_Committee_Points',htmacdinh:0,htdongian:1,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'Communal_People_Committee_Points',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Trạm thông tin',ename:'Telecommunation station',l:'Telecommunation_station_point',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Mức độ tổn thương của các công trình thủy lợi',ename:'Irrigations that were assessed vulnerability',l:'Vulnerability_irrigation_points_font_point',htmacdinh:0,htdongian:1,htchitiet:1,httuychon:1,singleTile:true,estyle:'Vulnerability_irrigation_points_en',style:'Vulnerability_irrigation_points',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Mức độ tổn thương của các công trình giao thông',ename:'Roads that were assessed vulnerability',l:'Vulnerability_roads_polyline',htmacdinh:0,htdongian:1,htchitiet:1,httuychon:1,singleTile:true,estyle:'vulnerability_roads_polyline_en',style:'vulnerability_roads_polyline',isBaseLayer:false,visibility:true});
mapLayers.push({name:'Khu dân cư',ename:'Residential area',l:'Residential_area_polygon',htmacdinh:0,htdongian:0,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
...
mapLayers.push({name:'Khu tập trung dân cư',ename:'High residential area density',l:'High_residential_area_density_polygon',htmacdinh:1,htdongian:1,htchitiet:1,httuychon:1,singleTile:true,estyle:'',style:'',isBaseLayer:false,visibility:true});
