...
function _project_html_2(){
    ...
    ret +='<label style="float:left;margin-left:10px;">Dự án: Tăng cường Khả năng Chống chịu Khí hậu cho Cơ sở hạ tầng các tỉnh miền núi phía Bắc<br/>Gói thầu: TĂNG CƯỜNG CƠ SỞ DỮ LIỆU KHÔNG GIAN VÀ ATLAS CHO CƠ SỞ HẠ TẦNG NÔNG THÔN CÁC TỈNH MIỀN NÚI PHÍA BẮC VIỆT NAM</label>';
    return '<div>' + ret + '</div>';
}
