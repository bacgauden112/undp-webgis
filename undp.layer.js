...
mapBlocks['csht_nongthon'] = { vi:'Cơ sở hạ tầng nông nghiệp'
     ,en:'Rural infrastructures'
     ,layers:[
...
mapBlocks['csht_dandung'] = { vi:'Các cơ sở hạ tầng dân dụng'
     ,en:'Public infrastructures'
     ,layers:[
...
mapBlocks['transportation'] = { vi:'Hệ thống đường giao thông và nhà cửa'
     ,en:'Transportation system and housing'
     ,layers:[
